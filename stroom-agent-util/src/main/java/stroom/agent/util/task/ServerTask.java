...
import stroom.agent.util.shared.SimpleThreadPool;
import stroom.agent.util.shared.Task;
import stroom.agent.util.shared.TaskId;
import stroom.agent.util.shared.ThreadPool;
...
public abstract class ServerTask<R> implements Task<R>, HasMonitor {
	...
	// getMonitor().addTerminateHandler(handler);
	// }
	//
	// @Override
	// public String getInfo() {
	// return getMonitor().getInfo();
	// }
	//
	// @Override
	// public void info(final Object... args) {
	// getMonitor().info(args);
	// }
	//
	// @Override
	// public Monitor getParent() {
	// return getMonitor().getParent();
	// }
