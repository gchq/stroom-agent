package stroom.agent.util.thread;

import stroom.agent.util.logging.StroomLogger;
import stroom.agent.util.task.ServerTask;
...
public final class ThreadUtil {
    ...
    /**
     * Try repeatedly to acquire a lock but give up if the supplied task is terminated.
     * 
     * @param lock
     *            The lock to acquire.
     * @param task
