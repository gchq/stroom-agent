...
public class HeaderMap implements Serializable, Map<String, String> {
	...
	// public void read(InputStream inputStream, boolean close) throws
	// IOException {
	// read(new InputStreamReader(inputStream), close);
	// }

	public void read(final InputStream inputStream, final boolean close)
			throws IOException {
		...
		// if (close) {
		// CloseableUtil.close(lineReader);
		// }
	}
	...
	public void write(final OutputStream outputStream, final boolean close)
			throws IOException {
		write(new OutputStreamWriter(outputStream, StreamUtil.DEFAULT_CHARSET),
				close);
	}

	public void write(final Writer writer, final boolean close)
			throws IOException {
		try {
			final List<CIString> sortedKeys = new ArrayList<CIString>(
					realMap.keySet());
	...
	public Set<java.util.Map.Entry<String, String>> entrySet() {
		final Set<java.util.Map.Entry<String, String>> rtnSet = new HashSet<Entry<String, String>>();
	...
	public Set<String> keySet() {
		final Set<String> rtnSet = new HashSet<String>();
