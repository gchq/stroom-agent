...
public class StroomZipFile implements Closeable {
	...
	public final static StroomZipEntry SINGLE_DATA_ENTRY = new StroomZipEntry(null,
			SINGLE_ENTRY_ZIP_BASE_NAME, StroomZipFileType.Data);
	public final static StroomZipEntry SINGLE_META_ENTRY = new StroomZipEntry(null,
			SINGLE_ENTRY_ZIP_BASE_NAME, StroomZipFileType.Meta);
	public final static StroomZipEntry SINGLE_CONTEXT_ENTRY = new StroomZipEntry(
			null, SINGLE_ENTRY_ZIP_BASE_NAME, StroomZipFileType.Context);
	...
	protected void finalize() throws Throwable {
		super.finalize();
		if (zipFile != null) {
			LOGGER.error("finalize() - Failed to close stream opened here",
					openStack);
		}
	}

	public InputStream getInputStream(String baseName, StroomZipFileType fileType)
			throws IOException {
	...
	public boolean containsEntry(String baseName, StroomZipFileType fileType)
			throws IOException {
		String fullName = getStroomZipNameSet().getName(baseName, fileType);
		if (fullName != null) {
